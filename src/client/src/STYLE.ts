...
const STYLE = Object.freeze({
  ...
  color: Object.freeze({
    ...
    primaryDark: '#1F3589',
    primaryLight: '#C7D2FF',
    primaryLighter: '#ECF1FD',
    primaryLightest: '#F5F7FC',
    secondary: '#880085',
    secondaryMedium: '#70006E',
    secondaryDark: '#630062',
    secondaryLight: '#E4B4E3',
    secondaryLighter: '#FFE5FE',
    secondaryLightest: '#FFF0FF',
    accent: '#FFBC20',
    error: '#EE204D',
    errorDark: '#A50021',
    success: '#27A773',
